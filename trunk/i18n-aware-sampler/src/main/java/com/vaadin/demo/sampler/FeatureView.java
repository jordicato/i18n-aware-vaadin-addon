...
public class FeatureView extends I18NHorizontalLayout {

    private static final String MSG_SHOW_SRC = "View Source";

    private Panel right;
    private I18NVerticalLayout left;
    ...
    public FeatureView() {
        ...
        I18NVerticalLayout rightLayout = new I18NVerticalLayout();
