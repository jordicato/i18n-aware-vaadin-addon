...
/**
 * Class to rewrite standard Vaadin apps to I18N-aware apps You give the src paths of original and converted apps. This class erases all dst exixting
...
public class I18NConverter {
    ...
    /**
	 * Renames a package to a new name accordig to rules: prefixsrcpackage and prefixdstpackage A call with ("a.c.b","a","ew") will return "ew.c.b"
	 * 
	 ...
	 * @return renamed package. If no prefixsrcpackage is matched, returns equals currentpackage
	 */
    ...
    private final I18NSupportReplacement[] i18nsr = new I18NSupportReplacement[] { new I18NSupportReplacement(I18NAwareCaption.class, "setCaption", "setCaptionMessage", 0), new I18NSupportReplacement(I18NAwareValue.class, "setValue", "setValueMessage", 0), new I18NSupportReplacement(null, "addTab", "addTab", 1) };
	 ...
	 * 
	 * @param oce
	 *            converts a Vaadin obtect creation into a a I18N object using the factory
	 * @return
	 */
