...
/**
 * The I18N BrowserFrame
 * 
 * @author Pedro Rodriguez ( OpnWorks )
 */
@GenerateInstantiateSubclassAspect
@SuppressWarnings("serial")
public class I18NBrowserFrame extends BrowserFrame implements I18NAwareComponentExpression, I18NAwareAltText {

	private I18NAwareComponentExpressionSupport i18NAwareComponentExpressionSupport;
	private I18NAwareComponentAltTextSupport i18NAwareComponentAltTextSupport;

	/**
	 * Creates a new i18n browserFrame. The value of the browserFrame is false and it is immediate by default.
	 */
	public I18NBrowserFrame() {
		super();
	}

	/**
	 * Creates a new i18n BrowserFrame with caption message key.
	 * 
	 * The value of the BrowserFrame is false and it is immediate by default.
	 * 
	 * @param captionKey
	 *            the BrowserFrame caption message key.
	 */
	public I18NBrowserFrame(@I18NAwareMessage String captionKey) {
		super(captionKey);
		setCaptionMessage(captionKey);
	}

	public I18NBrowserFrame(I18NExpression captionExpression) {
		super(captionExpression.getStringFinal());
		setCaptionMessage(captionExpression.getObjectlist());
	}

	/**
	 * Creates a new i18n BrowserFrame with caption message key and click listener.
	 * 
	 * @param captionKey
	 *            the BrowserFrame message key.
	 * @param listener
	 *            the BrowserFrame click listener.
	 */
	public I18NBrowserFrame(@I18NAwareMessage String captionKey, Resource resource) {
		super(captionKey, resource);
		setCaptionMessage(captionKey);
	}

	public I18NBrowserFrame(I18NExpression captionExpression, Resource resource) {
