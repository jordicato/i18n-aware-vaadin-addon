...
public class AbstractI18NTest {
	...
	public <T extends I18NAware> void assertI18NAwareMessagePresent(
			Class<T> clazz, int paramPos, Class<?>... paramTypes)
			throws SecurityException, NoSuchMethodException {

		assertThat(clazz, notNullValue());

		assertI18NAwareMessagePresent(clazz.getConstructor(paramTypes),
				paramPos);
	}

	public <T extends I18NAware> void assertI18NAwareMessagePresent(
			Constructor<T> constructor, int paramPos) {

		int[] i18NAwareMessageParameterPositions = I18NAwareMessageParametersHelper
				.getI18NAwareMessageParameters(constructor);

		assertThat(i18NAwareMessageParameterPositions, notNullValue());

		assertThat(Arrays.binarySearch(i18NAwareMessageParameterPositions,
				paramPos), greaterThanOrEqualTo(0));
	}

	public <T extends I18NAware> void assertI18NAwareMessagePresent(
			Class<T> clazz, String methodName, int paramPos, Class<?>... paramTypes)
			throws SecurityException, NoSuchMethodException {

		assertThat(clazz, notNullValue());

		assertI18NAwareMessagePresent(clazz.getMethod(methodName, paramTypes),
				paramPos);
	}
	...
	public <T extends I18NAware> void assertI18NAwareMessagePresent(
		...
		int[] i18NAwareMessageParameterPositions = I18NAwareMessageParametersHelper
				.getI18NAwareMessageParameters(method);
