...
public class QuickLinksView extends VerticalLayout implements View {
    ...
    public static final String NAME = "com.askvikrant.noticeboard.views.QuickLinksView.QuickLinks";
    ...
    private final Button btnNew = new Button("com.askvikrant.noticeboard.views.QuickLinksView.Add_New_QuickLink");

    private VerticalLayout vLayout = new VerticalLayout();

    private final Button btnSave = new Button("com.askvikrant.noticeboard.views.QuickLinksView.Save");

    private final Button btnUpdate = new Button("com.askvikrant.noticeboard.views.QuickLinksView.Update");

    private final Button btnCancel = new Button("com.askvikrant.noticeboard.views.QuickLinksView.Cancel");

    private final TextField tfName = new TextField("com.askvikrant.noticeboard.views.QuickLinksView.Link_Name");

    private final TextField tfUrl = new TextField("com.askvikrant.noticeboard.views.QuickLinksView.URL");
    ...
    class EditColumnGenerator implements Table.ColumnGenerator {
        ...
        public Component generateCell(Table source, Object itemId, Object columnId) {
            ...
            Button button = new Button("com.askvikrant.noticeboard.views.QuickLinksView.Edit");
    ...
    class DeleteColumnGenerator implements Table.ColumnGenerator {
        ...
        public Component generateCell(Table source, Object itemId, Object columnId) {
            final QuickLink quickLink = (QuickLink) itemId;
            Button button = new Button("com.askvikrant.noticeboard.views.QuickLinksView.Delete");
            button.setStyleName(BaseTheme.BUTTON_LINK);
            button.addClickListener(new ClickListener() {
