...
public class NoticePanel extends VerticalLayout {
	...
	public void setNotice(final Notice notice, final ArrayList<Attachment> attachments) {
		...
		Label lblDate = new Label("<div><span align=\"center\" style=\"background-color:#fafafa; color:#606060; font-size:9pt;\">"
				+ dateFormat.format(notice.getDate()) + "</span>" + "&nbsp;&nbsp;<span style=\"color:" + textColor + "; font-size:9pt;\">" + alert
				+ "</span></div>");
		Label lblDepartment = new Label("<div style=\"color:#606060; font-size:9pt;font-style:italic;\">" + notice.getDepartment() + "</div>");
		Label lblUser = new Label("<div><span align=\"center\" style=\"background-color:#fafafa; color:#606060; font-size:9pt;\">Posted by: </span>"
				+ "&nbsp;&nbsp;<span style=\"font-size:9pt;\">" + notice.getUserName() + "</span></div>");
