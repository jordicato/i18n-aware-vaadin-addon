...
public class NoticeSummaryPanel extends VerticalLayout {
    ...
    public void setNotice(final Notice notice) {
        ...
        switch(notice.getDays()) {
            case 0:
                {
                    alert = "com.askvikrant.noticeboard.components.NoticeSummaryPanel.Today";
                    textColor = "#ff0000";
                    break;
                }
            case 1:
                {
                    alert = "com.askvikrant.noticeboard.components.NoticeSummaryPanel.Yesterday";
                    textColor = "#ff6600";
                    break;
                }
            case 2:
        ...
        Label lblDate = new Label("<div align=\"center\" style=\"background-color:#fafafa; color:#606060; font-size:9pt;\">" + dateFormat.format(notice.getDate()) + "</div>");
        ...
        Button btnView = new Button("com.askvikrant.noticeboard.components.NoticeSummaryPanel.View");
        Button btnEdit = new Button("com.askvikrant.noticeboard.components.NoticeSummaryPanel.Edit");
        Button btnDelete = new Button("com.askvikrant.noticeboard.components.NoticeSummaryPanel.Delete");
