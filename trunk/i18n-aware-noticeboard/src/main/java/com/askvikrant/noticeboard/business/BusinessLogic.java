...
public class BusinessLogic {
    ...
    public boolean deleteUser(String userId) {
        ...
        try {
            ...
            if (count > 0) {
                success = false;
                databaseManager.setDbMessage("Notices exist posted by this user. " + "You should change the user password instead, to restrict user access.");
            } else {
                success = true;
            }
            if (success) {
    ...
    public boolean saveNewNotice(final String title, final String body, final ArrayList<Attachment> attachments, final String userId, final String department) {
        boolean success = false;
        try {
            databaseManager.resetDbMessage();
            if (!databaseManager.getConnection()) {
