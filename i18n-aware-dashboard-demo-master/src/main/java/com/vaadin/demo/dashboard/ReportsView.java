...
public class ReportsView extends HorizontalLayout implements View {
    ...
    private Component buildDraftsView() {
        ...
        editors.setCloseHandler(new CloseHandler() {
            ...
            public void onTabClose(TabSheet tabsheet, final Component tabContent) {
                ...
                Button discard = new Button("com.vaadin.demo.dashboard.ReportsView.Don_t_Save");
                ...
                Button cancel = new Button("com.vaadin.demo.dashboard.ReportsView.Cancel");
                ...
                Button ok = new Button("com.vaadin.demo.dashboard.ReportsView.Save");
                ...
                ok.addClickListener(new ClickListener() {
                    ...
                    public void buttonClick(ClickEvent event) {
                        ...
                        ((DashboardUI) UI.getCurrent()).updateReportsButtonBadge(draftCount + "");
                        alert.close();
                        Notification.show("The report was saved as a draft", "Actually, the report was just closed and deleted forever. As this is only a demo, it doesn't persist any data.", Type.TRAY_NOTIFICATION);
                    }
                });
                buttons.addComponent(ok);
                ok.focus();
                alert.addShortcutListener(new ShortcutListener("Cancel", KeyCode.ESCAPE, null) {
        ...
        center.setSizeFull();
        center.setCaption("com.vaadin.demo.dashboard.ReportsView.All_Drafts");
        ...
        Label draftsTitle = new Label("com.vaadin.demo.dashboard.ReportsView.Drafts");
        ...
        draftThumb.addLayoutClickListener(new LayoutClickListener() {
            ...
            public void layoutClick(LayoutClickEvent event) {
                if (event.getButton() == MouseButton.LEFT && event.getChildComponent() != delete) {
                    editors.addTab(createEditorInstance(1, null, null)).setClosable(true);
                    editors.setSelectedTab(editors.getComponentCount() - 1);
                }
            }
        });
        draft.setDescription("com.vaadin.demo.dashboard.ReportsView.Click_to_edit");
        delete.setDescription("com.vaadin.demo.dashboard.ReportsView.Delete_draft");
        VerticalLayout createBox = new VerticalLayout();
        createBox.setWidth(null);
        createBox.addStyleName("create");
        Button create = new Button("com.vaadin.demo.dashboard.ReportsView.Create_New");
    ...
    private HorizontalLayout createEditorInstance(int which, Transferable items, Table table) {
        if (!helpShown) {
            helpShown = true;
        ...
        if (which == 1) {
            ...
            editor.setCaption("com.vaadin.demo.dashboard.ReportsView.Generated_report_from_selected");
        } else {
            SimpleDateFormat df = new SimpleDateFormat();
            df.applyPattern("M/dd/yyyy");
            editor.setCaption(new I18NExpression("com.vaadin.demo.dashboard.ReportsView.Unnamed_Report", " (", draftCount, ")"));
        }
        ((DashboardUI) UI.getCurrent()).updateReportsButtonBadge(draftCount + "");
        draftCount++;
        ...
        final SortableLayout canvas = new SortableLayout(editor.getCaption(), which, items, table);
        canvas.setWidth("100%");
        ...
        Label help = new Label("com.vaadin.demo.dashboard.ReportsView.Drag_items_to_the_canvas");
        ...
        wrap.addComponent(l);
        Label caption = new Label("com.vaadin.demo.dashboard.ReportsView.Text_Block");
        ...
        wrap.addComponent(l);
        caption = new Label("com.vaadin.demo.dashboard.ReportsView.Top_10_Movies");
        caption.setSizeUndefined();
        wrap.addComponent(caption);
        ...
        wrap.addComponent(l);
        caption = new Label("com.vaadin.demo.dashboard.ReportsView.Top_4_Revenue");
        caption.setSizeUndefined();
        wrap.addComponent(caption);
    ...
    private CssLayout createTransactionLabel(final Item item) {
        ...
        Label l = new Label(df.format(((Date) item.getItemProperty("timestamp").getValue())) + "<br>" + item.getItemProperty("City").getValue().toString() + ", " + item.getItemProperty("Country").getValue().toString());
        l.setSizeUndefined();
        ...
        root.addComponent(l);
        l = new Label("Seats: " + item.getItemProperty("Seats").getValue().toString() + "<br>" + "Revenue: $" + new DecimalFormat("#.##").format(item.getItemProperty("Price").getValue()), ContentMode.HTML);
        l.setSizeUndefined();
    ...
    private class SortableLayout extends CustomComponent {
        ...
        public SortableLayout(String caption, int which, Transferable items, Table table) {
            ...
            Label l = new Label("com.vaadin.demo.dashboard.ReportsView.Drag_items_here");
            l.setSizeUndefined();
            if (which == 1) {
                ...
                labels.addComponent(new Label("<strong>Selected transactions</strong>", ContentMode.HTML));
                if (items != null) {
                    ...
                    if (val.contains(tt.getData("itemId"))) {
                        for (Object id : val) {
                            ...
                            if (item != null) labels.addComponent(createTransactionLabel(item));
                        }
                    } else {
                ...
                placeholder.setDropHandler(new DropHandler() {
                    ...
                    public void drop(DragAndDropEvent event) {
                        ...
                        if (sourceComponent != layout.getParent()) {
                            AbstractComponent c = createComponentFromPaletteItem(sourceComponent.getCaption(), null);
                            if (c != null) {
                                addComponent(c);
    ...
    private static WrappedComponent getWrappedComponent(Component content, DropHandler dropHandler) {
    ...
    private AbstractComponent createComponentFromPaletteItem(String caption, String data) {
        if (caption != null) {
            if (caption.equals("text")) {
                ...
                rta.setWidth("100%");
                if (data == null) rta.setValue(Generator.randomText(30)); else rta.setValue(data);
                l.addComponent(rta);
                final Label text = new Label();
                final Button save = new Button("com.vaadin.demo.dashboard.ReportsView.Save_1");
                ...
                save.addClickListener(new ClickListener() {
                    ...
                    public void buttonClick(ClickEvent event) {
                        if (save.getCaption().equals("Save")) {
                            ...
                            save.setDescription("com.vaadin.demo.dashboard.ReportsView.Edit");
                        } else {
                            l.addStyleName("edit");
                            ...
                            rta.focus();
                            rta.selectAll();
                            save.setCaption("com.vaadin.demo.dashboard.ReportsView.Save_2");
                            save.addStyleName("default");
                ...
                t.setCaption("com.vaadin.demo.dashboard.ReportsView.Top_10_Titles_by_Revenue");
    ...
    private class ReorderLayoutDropHandler implements DropHandler {
        ...
        public void drop(DragAndDropEvent dropEvent) {
            ...
            if (sourceComponent.getParent() != layout) {
                AbstractComponent c = getWrappedComponent(createComponentFromPaletteItem(sourceComponent.getCaption(), null), this);
                int index = 0;
    ...
    public void autoCreate(int which, Transferable items, Table table) {
        editors.addTab(createEditorInstance(which, items, table)).setClosable(true);
        editors.setSelectedTab(editors.getComponentCount() - 1);
    }
