 ...
 * 
 * The setLocale() method force a i18N update of all top level I18NAware items registered and the update gets propagated to all related I18NAware
 * items.
 * 
...
public interface I18NService {
	...
	/**
	 * Retrieve a message using an specific locale ( may contain {@link java.text.MessageFormat} arguments).
	 * 
	 * @param locale
	 *            the locale
	 * @param key
