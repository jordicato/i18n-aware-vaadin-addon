...
public class NoticesView extends VerticalLayout implements View {
	...
	private final Button btn07 = new Button("Last 7 days");
	private final Button btn15 = new Button("Last 15 days");
	private final Button btn30 = new Button("Last 30 days");
	...
	public NoticesView(final User u, String defaultDays) {
		...
		refresher.setRefreshInterval(60000); // check for new notices every minute
