...
public class SamplerApplication extends Application implements HttpServletRequestListener {
    ...
    public void init() {
        ...
        SamplerWindow mainWindow = new SamplerWindow();
    ...
    class SamplerWindow extends I18NWindow {
        ...
        private Component createTreeSwitch() {
            ...
            b.addStyleName("down");
            b.setDebugId("tree-switch-button");
            ...
            addGeneratedColumn("", new Table.ColumnGenerator() {
                public Component generateCell(Table source, Object itemId,
                    ...
                    if (feature instanceof FeatureSet) {
                        ...
                        ActiveLink b = new ActiveLink("View sample â€£",
                                new ExternalResource("#"
