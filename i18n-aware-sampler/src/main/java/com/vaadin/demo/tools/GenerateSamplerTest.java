...
public class GenerateSamplerTest {
    ...
    private static String NEXT_BUTTON = "vaadin=sampler::PID_Snext-button";
    private static String TOGGLE_TREE = "vaadin=sampler::PID_Stree-switch-button";
    ...
    public static void main(String[] args) {
        ...
        test.addCmd(
                "mouseClick",
                "vaadin=sampler::/VI18NVerticalLayout[0]/ChildComponentContainer[0]/VHorizontalLayout[0]/ChildComponentContainer[1]/VCustomComponent[0]/VHorizontalLayout[0]/ChildComponentContainer[0]/VActiveLink[0]/domChild[0]/domChild[0]",
                "1,1");
